...
const _stageRanges = {
	EARLY: { start: 0, end: 110 }, // First trimester
	MIDDLE: { start: 111, end: 240 }, // Second trimester
	LATE: { start: 241, end: 320 }, // Third trimester
	NEARTERM: { start: 321, end: 335 }, // Pre-foaling
	FOALING: { start: 336, end: 340 }, // Due date window
};

export const StageVisualization: FC<StageVisualizationProps> = ({
	horseId,
}) => {
			...
			<Stack gap='md'>
				<Group justify='space-between' align='center'>
					<div>
						...
						<Text c='dimmed' size='sm'>
							{status.currentDay} days completed
						</Text>
					</div>
				...
				<Stack gap='xs'>
					...
					<Group justify='space-between' mt='xs'>
						<Text fw={500}>
							{status.totalDays - status.currentDay} days
							remaining
						</Text>
						<Text c='dimmed' size='sm'>
