		...
		<Stack spacing='lg'>
			...
			<Card withBorder>
				...
				<Text size='sm' c='dimmed'>
					These guidelines are general recommendations. Always consult
					with your veterinarian for specific advice tailored to your
					mare's needs. Pay attention to any changes in behavior or
					condition and report concerns to your vet promptly.
				</Text>
			</Card>
		</Stack>
	);
